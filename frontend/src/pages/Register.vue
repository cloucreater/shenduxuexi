...
.floating-leaves .leaf-1 { top: 8%; left: 10%; animation-delay: 0s; font-size: 2.4rem; }
.floating-leaves .leaf-2 { top: 20%; right: 14%; animation-delay: 2s; font-size: 2rem; }
.floating-leaves .leaf-3 { bottom: 18%; left: 12%; animation-delay: 4s; font-size: 2.2rem; }
.floating-leaves .leaf-4 { bottom: 12%; right: 8%; animation-delay: 6s; font-size: 2.6rem; }
