...
const allArticles = ref([
  ...
  { id: 1, crop: '番茄', disease: '番茄早疫病', enName: 'Tomato Early Blight', category: '番茄', icon:'🍅',
  ...
  { id: 2, crop: '番茄', disease: '番茄晚疫病', enName: 'Tomato Late Blight', category: '番茄', icon:'🍅',
  ...
  { id: 3, crop: '番茄', disease: '番茄白粉病', enName: 'Tomato Powdery Mildew', category: '番茄', icon:'🍅',
  ...
  { id: 4, crop: '番茄', disease: '番茄灰霉病', enName: 'Tomato Gray Mold', category: '番茄', icon:'🍅',
  ...
  { id: 5, crop: '番茄', disease: '番茄叶霉病', enName: 'Tomato Leaf Mold', category: '番茄', icon:'🍅',
  ...
  { id: 6, crop: '番茄', disease: '番茄青枯病', enName: 'Tomato Bacterial Wilt', category: '番茄', icon:'🍅',
  ...
  { id: 7, crop: '番茄', disease: '番茄枯萎病', enName: 'Tomato Fusarium Wilt', category: '番茄', icon:'🍅',
  ...
  { id: 8, crop: '番茄', disease: '番茄斑枯病', enName: 'Tomato Septoria Leaf Spot', category: '番茄', icon:'🍅',
  ...
  { id: 9, crop: '番茄', disease: '番茄病毒病', enName: 'Tomato Viral Disease', category: '番茄', icon:'🍅',
  ...
  { id: 10, crop: '番茄', disease: '番茄脐腐病', enName: 'Tomato Blossom End Rot', category: '番茄', icon:'🍅',
  ...
  { id: 11, crop: '番茄', disease: '番茄黄化曲叶病毒病', enName: 'Tomato TYLCV', category: '番茄', icon:'🍅',
  ...
  { id: 12, crop: '番茄', disease: '番茄细菌性斑点病', enName: 'Tomato Bacterial Speck', category: '番茄', icon:'🍅',
  ...
  { id: 13, crop: '黄瓜', disease: '黄瓜霜霉病', enName: 'Cucumber Downy Mildew', category: '黄瓜', icon:'🥒',
  ...
  { id: 14, crop: '黄瓜', disease: '黄瓜白粉病', enName: 'Cucumber Powdery Mildew', category: '黄瓜', icon:'🥒',
  ...
  { id: 15, crop: '黄瓜', disease: '黄瓜细菌性角斑病', enName: 'Cucumber Angular Leaf Spot', category: '黄瓜', icon:'🥒',
  ...
  { id: 16, crop: '黄瓜', disease: '黄瓜枯萎病', enName: 'Cucumber Fusarium Wilt', category: '黄瓜', icon:'🥒',
  ...
  { id: 17, crop: '黄瓜', disease: '黄瓜灰霉病', enName: 'Cucumber Gray Mold', category: '黄瓜', icon:'🥒',
  ...
  { id: 18, crop: '黄瓜', disease: '黄瓜疫病', enName: 'Cucumber Phytophthora Blight', category: '黄瓜', icon:'🥒',
  ...
  { id: 19, crop: '黄瓜', disease: '黄瓜蔓枯病', enName: 'Cucumber Gummy Stem Blight', category: '黄瓜', icon:'🥒',
  ...
  { id: 20, crop: '黄瓜', disease: '黄瓜炭疽病', enName: 'Cucumber Anthracnose', category: '黄瓜', icon:'🥒',
  ...
  { id: 21, crop: '黄瓜', disease: '黄瓜根结线虫病', enName: 'Cucumber Root-Knot Nematode', category: '黄瓜', icon:'🥒',
  ...
  { id: 22, crop: '黄瓜', disease: '黄瓜靶斑病', enName: 'Cucumber Corynespora Leaf Spot', category: '黄瓜', icon:'🥒',
  ...
  { id: 23, crop: '辣椒', disease: '辣椒疫病', enName: 'Pepper Phytophthora Blight', category: '辣椒', icon:'🌶️',
  ...
  { id: 24, crop: '辣椒', disease: '辣椒炭疽病', enName: 'Pepper Anthracnose', category: '辣椒', icon:'🌶️',
  ...
  { id: 25, crop: '辣椒', disease: '辣椒病毒病', enName: 'Pepper Viral Disease', category: '辣椒', icon:'🌶️',
  ...
  { id: 26, crop: '辣椒', disease: '辣椒青枯病', enName: 'Pepper Bacterial Wilt', category: '辣椒', icon:'🌶️',
  ...
  { id: 27, crop: '辣椒', disease: '辣椒白粉病', enName: 'Pepper Powdery Mildew', category: '辣椒', icon:'🌶️',
  ...
  { id: 28, crop: '辣椒', disease: '辣椒疮痂病', enName: 'Pepper Bacterial Spot', category: '辣椒', icon:'🌶️',
  ...
  { id: 29, crop: '辣椒', disease: '辣椒灰霉病', enName: 'Pepper Gray Mold', category: '辣椒', icon:'🌶️',
  ...
  { id: 30, crop: '辣椒', disease: '辣椒枯萎病', enName: 'Pepper Fusarium Wilt', category: '辣椒', icon:'🌶️',
  ...
  { id: 31, crop: '辣椒', disease: '辣椒日灼病', enName: 'Pepper Sunscald', category: '辣椒', icon:'🌶️',
  ...
  { id: 32, crop: '辣椒', disease: '辣椒根腐病', enName: 'Pepper Root Rot', category: '辣椒', icon:'🌶️',
  ...
  { id: 33, crop: '土豆', disease: '马铃薯晚疫病', enName: 'Potato Late Blight', category: '土豆', icon:'🥔',
  ...
  { id: 34, crop: '土豆', disease: '马铃薯早疫病', enName: 'Potato Early Blight', category: '土豆', icon:'🥔',
  ...
  { id: 35, crop: '土豆', disease: '马铃薯黑胫病', enName: 'Potato Blackleg', category: '土豆', icon:'🥔',
  ...
  { id: 36, crop: '土豆', disease: '马铃薯病毒病', enName: 'Potato Viral Disease', category: '土豆', icon:'🥔',
  ...
  { id: 37, crop: '土豆', disease: '马铃薯疮痂病', enName: 'Potato Common Scab', category: '土豆', icon:'🥔',
  ...
  { id: 38, crop: '土豆', disease: '马铃薯环腐病', enName: 'Potato Ring Rot', category: '土豆', icon:'🥔',
  ...
  { id: 39, crop: '土豆', disease: '马铃薯青枯病', enName: 'Potato Bacterial Wilt', category: '土豆', icon:'🥔',
  ...
  { id: 40, crop: '土豆', disease: '马铃薯干腐病', enName: 'Potato Dry Rot', category: '土豆', icon:'🥔',
  ...
  { id: 41, crop: '土豆', disease: '马铃薯黑痣病', enName: 'Potato Black Scurf', category: '土豆', icon:'🥔',
  ...
  { id: 42, crop: '土豆', disease: '马铃薯粉痂病', enName: 'Potato Powdery Scab', category: '土豆', icon:'🥔',
  ...
  // ===== 小麦 (Wheat) - 10 entries =====
  { id: 43, crop: '小麦', disease: '小麦条锈病', enName: 'Wheat Stripe Rust', category: '小麦', icon:'🌾',
  ...
  { id: 44, crop: '小麦', disease: '小麦叶锈病', enName: 'Wheat Leaf Rust', category: '小麦', icon:'🌾',
  ...
  { id: 45, crop: '小麦', disease: '小麦白粉病', enName: 'Wheat Powdery Mildew', category: '小麦', icon:'🌾',
  ...
  { id: 46, crop: '小麦', disease: '小麦赤霉病', enName: 'Wheat Fusarium Head Blight', category: '小麦', icon:'🌾',
  ...
  { id: 47, crop: '小麦', disease: '小麦纹枯病', enName: 'Wheat Sharp Eyespot', category: '小麦', icon:'🌾',
  ...
  { id: 48, crop: '小麦', disease: '小麦全蚀病', enName: 'Wheat Take-all', category: '小麦', icon:'🌾',
  ...
  { id: 49, crop: '小麦', disease: '小麦散黑穗病', enName: 'Wheat Loose Smut', category: '小麦', icon:'🌾',
  ...
  { id: 50, crop: '小麦', disease: '小麦腥黑穗病', enName: 'Wheat Common Bunt', category: '小麦', icon:'🌾',
  ...
  { id: 51, crop: '小麦', disease: '小麦根腐病', enName: 'Wheat Common Root Rot', category: '小麦', icon:'🌾',
  ...
  { id: 52, crop: '小麦', disease: '小麦雪霉叶枯病', enName: 'Wheat Snow Mold', category: '小麦', icon:'🌾',
  ...
  // ===== 水稻 (Rice) - 10 entries =====
  { id: 53, crop: '水稻', disease: '水稻稻瘟病', enName: 'Rice Blast', category: '水稻', icon:'🌾',
  ...
  { id: 54, crop: '水稻', disease: '水稻纹枯病', enName: 'Rice Sheath Blight', category: '水稻', icon:'🌾',
  ...
  { id: 55, crop: '水稻', disease: '水稻白叶枯病', enName: 'Rice Bacterial Blight', category: '水稻', icon:'🌾',
  ...
  { id: 56, crop: '水稻', disease: '水稻稻曲病', enName: 'Rice False Smut', category: '水稻', icon:'🌾',
  ...
  { id: 57, crop: '水稻', disease: '水稻恶苗病', enName: 'Rice Bakanae Disease', category: '水稻', icon:'🌾',
  ...
  { id: 58, crop: '水稻', disease: '水稻胡麻斑病', enName: 'Rice Brown Spot', category: '水稻', icon:'🌾',
  ...
  { id: 59, crop: '水稻', disease: '水稻条纹叶枯病', enName: 'Rice Stripe Virus', category: '水稻', icon:'🌾',
  ...
  { id: 60, crop: '水稻', disease: '水稻细菌性条斑病', enName: 'Rice Bacterial Leaf Streak', category: '水稻', icon:'🌾',
  ...
  { id: 61, crop: '水稻', disease: '水稻干尖线虫病', enName: 'Rice White Tip Nematode', category: '水稻', icon:'🌾',
  ...
  { id: 62, crop: '水稻', disease: '水稻菌核秆腐病', enName: 'Rice Stem Rot', category: '水稻', icon:'🌾',
...
<template>
  <div class="space-y-6">
    ...
    <div class="glass animate-fade-up">
      <div style="display:flex;gap:12px;flex-wrap:wrap;">
        ...
        <select v-model="selectedCategory" class="form-select" style="width:180px;">
          <option value="all">🌱 全部分类 ({{ allArticles.length }})</option>
    ...
    <div class="stats-grid animate-fade-up stagger-2">
      ...
      >
        <div class="stat-icon" style="background:rgba(76,175,80,0.15);color:#4caf50;font-size:1.5rem;">
          {{ cat.icon }}
        </div>
        ...
        <div v-else ref="articlesRef" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:12px;">
          ...
          >
            <div style="display:flex;justify-content:space-between;align-items:start;margin-bottom:8px;">
              <span class="tag tag-success" style="font-size:0.7rem;">{{ article.icon }} {{ article.category }}</span>
      ...
      <div class="space-y-4 animate-slide-right">
        ...
        <div class="glass">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px;">
            <h3 style="font-weight:700;font-size:1rem;">💬 社区问答</h3>
        ...
        <!-- Quick Links -->
        <div class="glass">
          <h3 style="font-weight:700;margin-bottom:12px;font-size:1rem;">🔗 常用链接</h3>
          <div class="space-y-2">
        ...
        <!-- Stats -->
        <div class="glass">
          <h3 style="font-weight:700;margin-bottom:12px;font-size:1rem;">📊 知识库统计</h3>
          <div class="space-y-2">
      ...
      <div class="modal-content animate-scale-in">
        <div style="padding:24px 28px;border-bottom:1px solid rgba(255,255,255,0.06);">
          <div style="display:flex;justify-content:space-between;align-items:start;">
            <div>
              <span class="tag tag-success" style="margin-bottom:8px;">{{ selectedArticle.icon }} {{ selectedArticle.category }}</span>
            ...
            <button @click="closeArticle" style="padding:6px;border-radius:8px;border:none;background:rgba(255,255,255,0.08);color:var(--text-primary);cursor:pointer;font-size:1.2rem;">✕</button>
          </div>
        </div>
        <div style="padding:20px 28px 28px;" class="space-y-4">
          <div style="padding:16px;background:rgba(244,67,54,0.08);border-radius:12px;border-left:3px solid #f44336;">
            <h4 style="font-weight:700;margin-bottom:10px;">🔍 症状表现</h4>
          ...
          <div style="padding:16px;background:rgba(33,150,243,0.08);border-radius:12px;border-left:3px solid #2196f3;">
            <h4 style="font-weight:700;margin-bottom:10px;">🛡️ 预防措施</h4>
          ...
          <div style="padding:16px;background:rgba(76,175,80,0.08);border-radius:12px;border-left:3px solid #4caf50;">
            <h4 style="font-weight:700;margin-bottom:10px;">💊 治疗方案</h4>
        ...
        <div style="padding:16px 28px;border-top:1px solid rgba(255,255,255,0.06);display:flex;justify-content:space-between;align-items:center;">
          <span style="font-size:0.8rem;color:var(--text-muted);">{{ selectedArticle.views }} 次阅读 · 🦠 {{ selectedArticle.disease }} · 🌱 {{ selectedArticle.crop }}</span>
    ...
    <div v-if="showPesticideGuide" class="modal-overlay" @click.self="closePesticideGuide">
      <div class="modal-content animate-scale-in" style="max-width:820px;max-height:85vh;overflow-y:auto;">
        <div style="padding:20px 28px;border-bottom:1px solid rgba(255,255,255,0.06);display:flex;justify-content:space-between;align-items:center;">
          <div>
            <h2 style="font-weight:700;font-size:1.15rem;">💊 农药使用指南</h2>
            <p style="font-size:0.75rem;color:var(--text-tertiary);">共 {{ pesticideList.length }} 种常用农药 · 含杀菌剂/杀虫剂/杀线虫剂</p>
          </div>
          <button @click="closePesticideGuide" style="padding:6px;border-radius:8px;border:none;background:rgba(255,255,255,0.08);color:var(--text-primary);cursor:pointer;font-size:1.2rem;">✕</button>
        </div>
        <div style="padding:20px 28px;">
          ...
          <p style="margin-top:16px;font-size:0.7rem;color:var(--text-muted);text-align:center;">⚠ 以上为通用推荐，具体用量请参照产品标签和当地农技部门指导</p>
        </div>
      </div>
    </div>
    ...
    <div v-if="showFarmingCalendar" class="modal-overlay" @click.self="closeFarmingCalendar">
      <div class="modal-content animate-scale-in" style="max-width:820px;max-height:85vh;overflow-y:auto;">
        <div style="padding:20px 28px;border-bottom:1px solid rgba(255,255,255,0.06);display:flex;justify-content:space-between;align-items:center;">
          <div>
            <h2 style="font-weight:700;font-size:1.15rem;">📅 农事日历</h2>
            <p style="font-size:0.75rem;color:var(--text-tertiary);">四季农事管理 · 病虫害预防为主的综合农事建议</p>
          </div>
          <button @click="closeFarmingCalendar" style="padding:6px;border-radius:8px;border:none;background:rgba(255,255,255,0.08);color:var(--text-primary);cursor:pointer;font-size:1.2rem;">✕</button>
        </div>
        <div style="padding:20px 28px;">
    ...
    <div v-if="showTreatmentPlans" class="modal-overlay" @click.self="closeTreatmentPlans">
      <div class="modal-content animate-scale-in" style="max-width:820px;max-height:85vh;overflow-y:auto;">
        <div style="padding:20px 28px;border-bottom:1px solid rgba(255,255,255,0.06);display:flex;justify-content:space-between;align-items:center;">
          <div>
            <h2 style="font-weight:700;font-size:1.15rem;">🧪 防治方案汇总</h2>
            <p style="font-size:0.75rem;color:var(--text-tertiary);">覆盖 {{ treatmentPlans.length }} 类作物 · 共 {{ allArticles.length }} 种病害的完整防治方案</p>
          </div>
          <button @click="closeTreatmentPlans" style="padding:6px;border-radius:8px;border:none;background:rgba(255,255,255,0.08);color:var(--text-primary);cursor:pointer;font-size:1.2rem;">✕</button>
        </div>
        <div style="padding:20px 28px;">
          <div v-for="(group, gi) in treatmentPlans" :key="group.crop"
            ...
            <div v-for="a in group.articles" :key="a.id"
              ...
              <div style="display:flex;justify-content:space-between;align-items:start;margin-bottom:8px;">
                <h4 style="font-weight:700;font-size:0.88rem;">🦠 {{ a.disease }}</h4>
              ...
              <div style="padding:10px 14px;background:rgba(76,175,80,0.06);border-radius:10px;border-left:3px solid var(--color-accent);">
                <span style="font-size:0.7rem;font-weight:700;color:var(--color-accent);">💊 治疗方案：</span>
    ...
    <div v-if="showQuestionModal" class="modal-overlay" @click.self="closeQuestionModal">
      <div class="modal-content animate-scale-in" style="max-width:480px;">
        <div style="padding:20px 28px;border-bottom:1px solid rgba(255,255,255,0.06);display:flex;justify-content:space-between;align-items:center;">
          <h2 style="font-weight:700;font-size:1.1rem;">💬 发布问题</h2>
          <button @click="closeQuestionModal" style="padding:6px;border-radius:8px;border:none;background:rgba(255,255,255,0.08);color:var(--text-primary);cursor:pointer;font-size:1.2rem;">✕</button>
        </div>
